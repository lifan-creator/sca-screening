"""
SCA Screening - Task 1: Daily Behavioral Posture Questionnaire
================================================================================
...
def plot_roc_curves(results, output_file):
    ...
    ax.set_title('ROC Curves - Daily Behavioral Posture Module', fontsize=14, fontweight='bold', pad=20)
...
def main():
    ...
    """
    print("="*80)
    print("SCA SCREENING - TASK 1: DAILY_BEHAVIORAL_POSTURE MODULE")
    print("="*80)
