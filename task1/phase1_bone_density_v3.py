"""
AIS Risk Prediction - Phase 1: bone_density Module Single-Task Risk Modeling
================================================================================
...
def plot_roc_curves(results, output_file):
    ...
    ax.set_title('ROC Curves - bone_density Module Models', fontsize=14, fontweight='bold', pad=20)
...
def main():
    ...
    """
    print("="*80)
    print("AIS RISK PREDICTION - PHASE 1: bone_density MODULE")
    print("="*80)
