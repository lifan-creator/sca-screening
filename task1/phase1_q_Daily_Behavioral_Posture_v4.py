"""
AIS Risk Prediction - Phase 1: Questionnaire Module Single-Task Risk Modeling
================================================================================
This script performs binary classification for AIS risk prediction using
questionnaire features with strict 10-fold cross-validation to avoid data leakage.
...
OUTPUT_DIR = r"D:\科研\ais_multimodal_multitask_pipeline\outputs\phase1\v4"
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "Daily_Behavioral_Posture_benchmark_results.xlsx")
ROC_PLOT_FILE = os.path.join(OUTPUT_DIR, "Daily_Behavioral_Posture_roc_curves.png")
...
def load_and_prepare_data(filepath):
    ...
    feature_cols = ['q_q_dominant_hand','q_q_bed_device_use','q_q_sleep_posture','q_q_sleep_duration','q_q_bag_style','q_q_bag_carry_posture','q_q_school_sitting_posture_1', 'q_q_school_sitting_posture_2','q_q_school_sitting_posture_3','q_q_school_sitting_posture_4','q_q_school_sitting_posture_5','q_q_daily_conversation_posture_1','q_q_daily_conversation_posture_2','q_q_daily_conversation_posture_3','q_q_daily_conversation_posture_4','q_q_daily_conversation_posture_5','q_q_computer_sitting_posture_1','q_q_computer_sitting_posture_2','q_q_computer_sitting_posture_3','q_q_computer_sitting_posture_4','q_q_computer_sitting_posture_5','q_q_device_reading_posture_1','q_q_device_reading_posture_2','q_q_device_reading_posture_3','q_q_standing_device_use_1','q_q_standing_device_use_2','q_q_standing_device_use_3','q_q_object_lifting_method_1','q_q_object_lifting_method_2','q_q_object_lifting_method_3','q_q_object_lifting_method_4' ]
...
def plot_roc_curves(results, output_file):
    ...
    ax.set_title('ROC Curves - Questionnaire Module Models', fontsize=14, fontweight='bold', pad=20)
...
def main():
    ...
    """
    print("="*80)
    print("AIS RISK PREDICTION - PHASE 1: QUESTIONNAIRE MODULE")
    print("="*80)
