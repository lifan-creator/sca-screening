...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "Pain_Assessment_benchmark_results.xlsx")
ROC_PLOT_FILE = os.path.join(OUTPUT_DIR, "Pain_Assessment_roc_curves.png")
...
def load_and_prepare_data(filepath):
    ...
    feature_cols = ['q_q_low_back_pain',
                    'q_q_low_back_pain_frequency',
                    'q_q_low_back_pain_impact',
                    'q_q_low_back_pain_intensity',
                    'q_q_neck_shoulder_pain',
                    'q_q_neck_shoulder_pain_frequency',
                    'q_q_neck_shoulder_pain_impact',
                    'q_q_neck_shoulder_pain_intensity'
                    ]
