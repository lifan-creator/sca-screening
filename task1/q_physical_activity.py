"""
SCA Screening - Task 1: Physical Activity Questionnaire
================================================================================
...
def plot_roc_curves(results, output_file):
    ...
    ax.set_title('ROC Curves - Physical Activity Module', fontsize=14, fontweight='bold', pad=20)
...
def main():
    ...
    """
    print("="*80)
    print("SCA SCREENING - TASK 1: PHYSICAL_ACTIVITY MODULE")
    print("="*80)
