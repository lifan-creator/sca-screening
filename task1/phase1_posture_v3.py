"""
AIS Risk Prediction - Phase 1: Posture Module Single-Task Risk Modeling
================================================================================
This script performs binary classification for AIS risk prediction using
Posture features with strict 10-fold cross-validation to avoid data leakage.
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "Posture_benchmark_results.xlsx")
ROC_PLOT_FILE = os.path.join(OUTPUT_DIR, "Posture_roc_curves.png")
...
def plot_roc_curves(results, output_file):
    ...
    ax.set_title('ROC Curves - Posture Module Models', fontsize=14, fontweight='bold', pad=20)
...
def main():
    ...
    """
    print("="*80)
    print("AIS RISK PREDICTION - PHASE 1: Posture MODULE")
    print("="*80)
