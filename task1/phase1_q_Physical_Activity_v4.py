...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "Physical_Activity_benchmark_results.xlsx")
ROC_PLOT_FILE = os.path.join(OUTPUT_DIR, "Physical_Activity_roc_curves.png")
...
def load_and_prepare_data(filepath):
    ...
    feature_cols = ['q_q_vigorous_activity_days','q_q_vigorous_activity_duration','q_q_moderate_activity_days','q_q_moderate_activity_duration','q_q_walking_days','q_q_walking_duration','q_q_workday_sitting_time','q_q_screen_time_daily','q_q_average_sitting_bout']
