...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "Demographics_benchmark_results.xlsx")
ROC_PLOT_FILE = os.path.join(OUTPUT_DIR, "Demographics_roc_curves.png")
...
def load_and_prepare_data(filepath):
    ...
    feature_cols = ['q_sex', 'q_age', 'q_height_cm', 'q_weight_kg']
