"""
SCA Screening - Task 1: Body Composition Module
================================================================================
...
def plot_roc_curves(results, output_file):
    ...
    ax.set_title('ROC Curves - Body Composition Module', fontsize=14, fontweight='bold', pad=20)
...
def main():
    ...
    """
    print("="*80)
    print("SCA SCREENING - TASK 1: body_composition MODULE")
    print("="*80)
