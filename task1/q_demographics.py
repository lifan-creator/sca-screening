"""
SCA Screening - Task 1: Demographics Questionnaire
================================================================================
...
def plot_roc_curves(results, output_file):
    ...
    ax.set_title('ROC Curves - Demographics Module', fontsize=14, fontweight='bold', pad=20)
...
def main():
    ...
    """
    print("="*80)
    print("SCA SCREENING - TASK 1: DEMOGRAPHICS MODULE")
    print("="*80)
