...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "Spine_Health_Perception_benchmark_results.xlsx")
ROC_PLOT_FILE = os.path.join(OUTPUT_DIR, "Spine_Health_Perception_roc_curves.png")
...
def load_and_prepare_data(filepath):
    ...
    feature_cols = ['q_q_spine_health_knowledge',
                    'q_q_spine_disease_knowledge',
                    'q_q_education_satisfaction',
                    'q_q_posture_awareness',
                    'q_q_learning_willingness',
                    'q_q_health_investment_willingness',
                    'q_q_course_awareness',
                    'q_q_back_status_feeling',
                    'q_q_appearance_with_clothes',
                    'q_q_trunk_appearance',
                    'q_q_social_impact',
                    'q_q_self_attractiveness'
                    ]
