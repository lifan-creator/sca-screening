"""
AIS Risk Prediction - Phase 1: spinal_curvature Module Single-Task Risk Modeling
================================================================================
This script performs binary classification for AIS risk prediction using
spinal_curvature features with strict 10-fold cross-validation to avoid data leakage.
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "spinal_curvature_benchmark_results.xlsx")
ROC_PLOT_FILE = os.path.join(OUTPUT_DIR, "spinal_curvature_roc_curves.png")
...
def load_and_prepare_data(filepath):
    ...
    feature_cols = [col for col in df.columns if col.startswith('sc_')]
...
def plot_roc_curves(results, output_file):
    ...
    ax.set_title('ROC Curves - spinal_curvature Module Models', fontsize=14, fontweight='bold', pad=20)
...
def main():
    ...
    """
    print("="*80)
    print("AIS RISK PREDICTION - PHASE 1: spinal_curvature MODULE")
    print("="*80)
