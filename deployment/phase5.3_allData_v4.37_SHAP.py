...
# 使用你生成的模块风险数据
DATA_PATH = r"D:\科研\ais_multimodal_multitask_pipeline\outputs\phase4\risk_index_v5.1\module_risk_dataset_v5.3.xlsx"
OUTPUT_DIR = r"D:\科研\ais_multimodal_multitask_pipeline\outputs\phase4\shapv5.3"
