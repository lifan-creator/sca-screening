"""
SCA Screening - Deployment: Cost-Aware Configuration K=8
================================================================
Soft-voting ensemble trained on the top-8 SHAP-ranked MoRIs (cost-aware reduced configuration).
"""
...
# ── User Configuration ──────────────────────────────────────────────────────
# This script uses the top-8 SHAP-ranked MoRIs (K=8 deployment configuration).
# DATA_PATH: K=8 MoRI dataset generated by selecting the top-8 MoRI columns from
#            outputs/mori/mori_dataset_K20.xlsx, then saving as mori_dataset_K8.xlsx.
# OUTPUT_DIR: directory where results will be saved.
DATA_PATH = "outputs/mori/mori_dataset_K8.xlsx"
OUTPUT_DIR = "outputs/deployment/K8"
# ────────────────────────────────────────────────────────────────────────────
...
def main():
    start = datetime.now()
    logger.info("=" * 80)
    logger.info("SCA Screening - Deployment K=8: top-8 SHAP-ranked MoRIs")
    logger.info("=" * 80)
